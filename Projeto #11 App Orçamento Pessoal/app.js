...
class Bd {
	...
	recuperarTodosRegistros () {
		...
		for (let i = 1; i <= id; i++) {
			...
			//existe a possibilidade de itens removidos
			if (despesa === null) {
				continue
			}
...
function cadastrarDespesa () {
	...
	if (despesa.validarDados()) {
		...
		document.getElementById('modalTitulo').innerHTML = 'Erro na gravção'
		document.getElementById('modalConteudo').innerHTML = 'Existem campos obrigatórios que não foram preenchios'
